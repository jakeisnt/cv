...
\begin{minipage}[t]{0.33\textwidth} % The left column takes up 33% of the text width of the page
  ...
  \section{Jake Chvatal} % Your name
  \urlstyle{same}\url{https://jake.chvatal.com} 
  \urlstyle{same}\url{https://github.com/jakeisnt} \\ % Your website, LinkedIn profile or other web address
