...
\begin{minipage}[t]{0.33\textwidth} % The left column takes up 33% of the text width of the page
  ...
  \namesection{Jake}{Chvatal} % Your name
  \sectionspace
  \begin{tabular}[t]{lll}
  Website &\href{https://jake.chvatal.com}{\bf jake.chvatal.com} \\
  Email &\href{mailto:chvatal.j@northeastern.edu}{chvatal.j@northeastern.edu} \\
  Phone &\href{sms://15033308568}{+1 503.330.8568} \\
...
\begin{minipage}[t]{0.66\textwidth} % The right column takes up 66% of the text width of the page
  ...
  \runsubsection{The Routing Company}
  \descript{| Software Engineering Intern}
  \location{January 2022 – August 2022 | Cambridge, MA}
